...
$hadOld = $false
foreach ($path in @($ourPref, $ourCfg, $ourHelper, $ourLauncher, $ourSecretHelper, $ourSecretLauncher)) {
...
Write-Host ''
Read-Host 'Nacisnij Enter, aby zamknac instalator'
